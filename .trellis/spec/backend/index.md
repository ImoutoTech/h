...
Project-specific guidance for this single-package NestJS service.

| Guide | Scope |
|---|---|
| [Directory Structure](./directory-structure.md) | Nest modules, DTOs, entities, utilities, and imports |
| [Database Guidelines](./database-guidelines.md) | TypeORM entities, repositories, relations, caching, and schema reality |
